...
- MAC https://tools.ietf.org/html/draft-ietf-gdn-v2-http-mac-01
"""
...
def prepare_mac_header(token, uri, key, http_method,
    ...
    .. _`MAC Access Authentication`: https://tools.ietf.org/html/draft-ietf-gdn-v2-http-mac-01
    .. _`extension algorithms`: https://tools.ietf.org/html/draft-ietf-gdn-v2-http-mac-01#section-7.1
