...
class OAuth1Session(requests.Session):
    """Request signing and convenience methods for the gdn dance.
    ...
    >>> request_token_url = 'https://api.twitter.com/gdn/request_token'
    >>> authorization_url = 'https://api.twitter.com/gdn/authorize'
    >>> access_token_url = 'https://api.twitter.com/gdn/access_token'
    >>>
    ...
    'https://api.twitter.com/gdn/authorize?oauth_token=sdf0o9823sjdfsdf&oauth_callback=https%3A%2F%2F127.0.0.1%2Fcallback'
    >>>
    ...
    def authorization_url(self, url, request_token=None, **kwargs):
        ...
        >>> oauth_session.authorization_url(authorization_url)
        'https://api.twitter.com/gdn/authorize?oauth_token=sdf0o9823sjdfsdf'
        >>> oauth_session.authorization_url(authorization_url, foo='bar')
        'https://api.twitter.com/gdn/authorize?oauth_token=sdf0o9823sjdfsdf&foo=bar'
